package com.plantherbs.app.verification
...
class VerificationActivity : AppCompatActivity() {
    ...
    private fun extractOtpCode(messageBody: String): String {
        // Implementasikan logika untuk mengekstrak kode OTP dari pesan SMS
        // Sesuaikan dengan format pesan SMS yang Anda terima
        // Contoh sederhana: Ambil 6 karakter terakhir dari pesan
        val otpLength = 6
